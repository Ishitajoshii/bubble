...
// ─────────────────────────────────────────────────────────────────────────────
// Bubble_straight.svg inlined as a data URI
// (replaces: import BubbleStraight from "../../../../Bubble straight.svg")
// ─────────────────────────────────────────────────────────────────────────────
...
export default function ConvergenceGraph() {
  ...
  useEffect(() => {
    function frame() {
      ...
      void dirty; // consumed by React state updates above
  ...
  useEffect(() => {
    ...
    else if (tickRef.current !== null) clearInterval(tickRef.current);
...
interface StatCardProps { label: string; value: string; sub: string; bar: string; }
...
interface BtnProps { children: React.ReactNode; primary?: boolean; onClick: () => void; }
